...
class Descriptive():
    ...
    def descriptive_Analysis(self,dataset,quantative):
        ...
        des_data=des_data.apply(np.floor)
    ...
    def changeoutlier(self,dataset,descriptive,lesser,greater):
        for lesscolumn in lesser:
            dataset[lesscolumn][dataset[lesscolumn]<descriptive[lesscolumn]["Lesser"]]=descriptive[lesscolumn]["Lesser"]
        for greatcolumn in greater:
            dataset[greatcolumn][dataset[greatcolumn]>descriptive[greatcolumn]["Greater"]]=descriptive[greatcolumn]["Greater"]
            #dataset[greatcolumn][dataset[greatcolumn]>descriptive[greatcolumn]["Greater"]] = descriptive[greatcolumn]["Greater"]
        return dataset
